...
{% hint style="info" %}
CSV مخفف "مقادیر جدا شده با کاما" است. این یک قالب متن ساده است که نیاز به وارد کردن، استخراج یا ذخیره اطلاعات به سادگی در قالب غیر اختصاصی است. تقریباً همه ابزارهای مدیریت داده در قالب­های مختلف از قالب CSV پشتیبانی می­کنند. می توانید اطلاعات بیشتر در مورد قالب CSV را در [ویکی پدیا](http://en.wikipedia.org/wiki/Comma-separated\_values.) بخوانید.
{% endhint %}
